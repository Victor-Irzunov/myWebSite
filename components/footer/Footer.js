	...
	return (
		<footer className="bg-[#15579e] pt-16 pb-6">
			<div className="container mx-auto px-3">
				...
				<aside className="mt-8 text-xs text-slate-300 font-light border-t border-gray-300 pt-2">
					<p className="">
					...
					<p className="">
						Ирзунов Виктор Константинович УНП KA5795000 Государственная регистрация от 06.03.2023, Инспекция МНС по Первомайскому району г.Минска
					</p>
					<p className="">
						Номер счета
