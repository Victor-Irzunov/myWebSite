		...
		<footer className="bg-[#15579e] pt-16 pb-6">
			<div className="container mx-auto px-3">
				...
				<div className="mt-8 text-xs text-slate-300 font-light border-t border-gray-300 pt-2">
					<p className="">
						&copy; 2023 компания «VI:TECH» Все права защищены. Информация на сайте не является публичной офертой и предоставляется исключительно в информационных целях.
					</p>
					<p className="">
