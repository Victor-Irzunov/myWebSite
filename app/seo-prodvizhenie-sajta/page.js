...
export const metadata = {
	...
	alternates: {
		canonical: 'https://vi-tech.by/seo-prodvizhenie-sajta'
	}
}
	...
	return (
		<main className="pt-16 pb-20">
			...
			<div className='mt-16 container mx-auto'>
				...
				<Link href={`${process.env.NEXT_PUBLIC_BASE_URL}/kontekstnaya-reklama`} className="flex underline uppercase text-[#004C97] text-sm">
